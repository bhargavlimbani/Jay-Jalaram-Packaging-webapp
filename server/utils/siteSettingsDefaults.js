const defaultBranding = {
  companyName: "Jai Jalaram Packaging",
  kicker: "Industrial Packaging",
  description: "Corrugated boxes built for transport, display, and custom branding.",
  logoData: "",
  logoAlt: "Jai Jalaram Packaging",
};
...
const defaultHome = {
  ...
  addressText: "Shapar Veraval, Rajkot, Gujarat - 360024",
  addressLink: "https://maps.app.goo.gl/6inbbi8fCPFi9qh3A",
};

module.exports = { defaultBranding, defaultHome };
